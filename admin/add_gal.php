...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $sql = "INSERT INTO gallery (department_assoc, event_title, event_description, venue, date, photo_one, photo_two, photo_three, photo_four) VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?)";

    $stmt = $conn->prepare($sql);

    if ($stmt) {
        $stmt->bind_param('sssssssss', $department, $event_title, $event_description, $venue, $date, $photo_one, $photo_two, $photo_three, $photo_four);
